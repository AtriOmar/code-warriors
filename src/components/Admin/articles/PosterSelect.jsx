...
function PosterSelect({ input, setInput }) {
  ...
  return (
    <div
      className={`mt-3 relative w-full max-w-[500px] rounded-lg border border-slate-300 ${input.photo ? "" : "cursor-pointer"}`}
      ...
      {input.photo ? (
        ...
        <>
          ...
          >
            ...
            <p className="absolute top-[120%] font-medium text-sm scr800:text-lg">2:1</p>
          </span>
        </>
      )}
